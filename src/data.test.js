...
describe('招生内容', () => {
  ...
  it('Supabase 不可用时的静态回退仍包含完整院校墙与十六所学习地图', () => {
    ...
    expect(schoolGroups(fallbackContent.offerings, fallbackContent.academicSchools, DEFAULT_SCOPE, fallbackContent.syllabusPoints)).toHaveLength(16)
  })
