...
describe('招生内容', () => {
  it('仅包含十五所已完成计划与考纲闭环的院校', () => {
    expect(schoolGroups().map((school) => school.school_name)).toEqual([
      '安徽建筑大学', '铜陵学院', '蚌埠学院', '合肥大学', '淮南师范学院', '合肥师范学院', '马鞍山学院', '安徽新华学院', '合肥经济学院', '安徽三联学院',
      '安徽信息工程学院', '淮北理工学院', '皖江工学院', '安徽文达信息工程学院', '阜阳理工学院',
    ])
  })
  ...
  it('Supabase 不可用时的静态回退仍包含完整院校墙与十五所学习地图', () => {
    ...
    expect(schoolGroups(fallbackContent.offerings, fallbackContent.academicSchools, DEFAULT_SCOPE, fallbackContent.syllabusPoints)).toHaveLength(15)
  })
